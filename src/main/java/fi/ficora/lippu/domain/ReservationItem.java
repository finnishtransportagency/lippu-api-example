...
public class ReservationItem {
    ...
    public ReservationItem setChosenExtraReservationData(List<String>
                                                                 chosenExtraReservationData) {
    ...
    public void setExtraServiceFeatures(Map<String, ExtraServiceFeature>
