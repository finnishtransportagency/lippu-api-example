...
public class KeyUtil {
     ...
     */
    public static PublicKey getPublicKey(String keyPath) throws
        ...
        try {
            ...
            reader = new PemReader(new InputStreamReader(fileStream, Charset.forName
                    ("UTF-8")));
     ...
     * @throws InvalidKeySpecException
     */
    public static PrivateKey getPrivateKey(String keyPath) throws
            NoSuchAlgorithmException, IOException, InvalidKeySpecException {
        final KeyFactory keyFactory = KeyFactory.getInstance("RSA");
