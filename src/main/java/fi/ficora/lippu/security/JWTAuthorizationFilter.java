...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse
        ...
        if (auth == null) {
            ...
            log.info("Authentication valid for {}, continue request processing.", auth
                    .getPrincipal());
        ...
        try {
            ...
            if (token != null) {
                ...
                JwtConsumer jwtConsumer = new JwtConsumerBuilder()
                        .setRequireExpirationTime().setAllowedClockSkewInSeconds(20)
                        .setRequireSubject().setSkipDefaultAudienceValidation()
                        .setExpectedIssuer(dataRepository.getOperator())
                        .setDecryptionKey(privateKey).setVerificationKey(key)
