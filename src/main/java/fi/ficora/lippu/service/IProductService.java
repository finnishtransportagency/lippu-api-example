...
public interface IProductService {
     ...
     * @param accessiblity List of {@link Accessibility} features, that are required by
     *                     the product.
     * @return List of products available.
     */
    ProductList getAvailableProducts(LocalDate date, List<Accessibility> accessiblity);

    /**
     * Get available products for the given date and transport departure coordinate.
     *
     ...
     */
    ProductList getAvailableProductsFrom(LocalDate date, Double fromLat, Double
            fromLon, List<Accessibility> accessiblity);

    /**
     * Get available products for the given date and transport destination coordinate.
     *
     * @param date         The date the products operate on
     ...
     */
    ProductList getAvailableProductsTo(LocalDate date, Double toLat, Double toLon,
                                       List<Accessibility> accessiblity);

    /**
     * Get available products for the given date, departure coordinates and destination
     * coordinates.
     *
     * @param date         The date the products operate on
     * @param fromLat      Latitude part of the departure coordinate
     ...
     * @param accessiblity List of {@link Accessibility} features, that are required by
     *                     the product.
     * @return List of products available for the date, departure and destination
     * coordinates.
     */
    ProductList getAvailableProducts(LocalDate date, Double fromLat, Double fromLon,
                                     Double toLat, Double toLon, List<Accessibility>
                                             accessiblity);
     ...
     * @return TransportInfo for the product
     */
    TransportInfo getTransport(String id);
    ...
    /**
     * Retrieves product for the travel departure, destination and travel date.
     *
     ...
     */
    Product getProduct(TravelRequest travel, String contract) throws
            TimetableNotFoundException;

    /**
     * Checks if product has all the required accessibility features required by the
     * parameter
     * accessibilities.
     *
     ...
     * false.
     */
    boolean hasRequiredAccessibityFeatures(Product product, List<? extends
            AccessibilityBase> accessibilities);

    /**
     * Search certain {@link Accessibility} from the products accessibilities. The
     * accessibility is
     * given as the title attribute to the method.
     *
     ...
     * @return The given {@link Accessibility} object from the product or null if not
     * found.
     */
    AccessibilityFeature getAccessibilityFromProduct(Product product, Accessibility
            .TitleEnum title);

    /**
     * Search certain {@link ExtraService} from the products extraServices. The
     * ExtraServiceFeature's
     ...
     * @return The {@link ExtraService} object from the product or null if not found.
     */
