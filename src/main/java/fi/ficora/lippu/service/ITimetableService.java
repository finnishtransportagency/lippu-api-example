...
/**
 * Interface for transport timetable operations service. Current design decision is
 * that one product can have only one departure per day.
 *
 * @author markkuko
 */
public interface ITimetableService {
    ...
    /**
     * Computes does the product given as a parameters operate on the given day and is the
     *
     ...
     * otherwise.
     */
    boolean hasProductDepartures(OffsetDateTime departure, OffsetDateTime arrival,
                                 Product product) throws TimetableNotFoundException;
    ...
    /**
     * Computes which products have departures on the given week day.
     *
