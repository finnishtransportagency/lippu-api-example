...
/**
 * Handles authentication and authorization services, provides challenge for client
 * authentication
 * (nonce), verification of the challenge and JWT creation and authorization functions.
 *
 * @author markkuko
 */
public interface IAuthService {
     ...
     * @return Authentication for client which has JWT Authentication token, expire
     *         time and clientId.
     * @throws UnsupportedEncodingException    Unsupported encoding when reading file.
     * @throws JoseException                   Exception in JWT creation.
     * @throws AuthVerificationFailedException General auth verification failed due to
     *                                         invalid parameters or invalid signature
     *                                         in the payload.
     */
    Auth verifyAuthentication(String data, String cnonce, String snonce, String keyId,
                              String alg) throws UnsupportedEncodingException,
            JoseException, AuthVerificationFailedException;
